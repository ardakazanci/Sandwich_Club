...
public class MainActivity extends AppCompatActivity implements GreenAdapter.ListItemClickListener {
    ...
    @Override
    public void onListItemClick(int holderPosition) {
        if (mToast != null) {
            mToast.cancel();
        }

        String toastMessage = "Item #" + holderPosition + " clicked";
        mToast = Toast.makeText(this, toastMessage, mToast.LENGTH_SHORT);
        mToast.show();
